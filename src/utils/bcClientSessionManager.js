  ...
  async startNewSession() {
    try {
      if (window && window.bcClient) {
        ...
        window.bcClient.startNewSession();
        ...
        console.warn(WINDOW_BCCLIENT_NOT_EXIST);
      }
    } catch (error) {
...
export const bcClientSessionManager = new BcClientSessionManager();

// Convenience functions for backward compatibility
export const initializebcClient = () =>
  bcClientSessionManager.initializeApplication();
export const startNewBioCatchSession = () =>
  bcClientSessionManager.startNewSession();
export const getCurrentBioCatchCSID = () =>
  bcClientSessionManager.getCurrentCSID();
export const updateBioCatchActivity = () =>
  bcClientSessionManager.updateActivity();
export const endBioCatchSession = () => bcClientSessionManager.endSession();
export const handleBioCatchLogout = () => bcClientSessionManager.handleLogout();
export const handleBioCatchLogin = (csid) =>
  bcClientSessionManager.handleLogin(csid);

export default bcClientSessionManager;
